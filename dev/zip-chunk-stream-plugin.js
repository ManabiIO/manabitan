...
/**
 * Apply the small splitter backport to both the host and worker bundles without
 * modifying node_modules or vendoring the ZIP parser/codecs. Fail closed on a
 * dependency update so the backport cannot silently patch a different source.
 * The untouched source prefix retains zip.js's copyright and BSD license.
