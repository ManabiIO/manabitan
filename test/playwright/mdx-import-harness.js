...
export const localMdxDictionaryTitle = 'Manabitan Manual MDX Yome Dictionary';
export const localMdxDescription = 'A tiny hand-built MDX dictionary for manually testing 読め lookups in Manabitan. Includes entries for Read, read, and 読め.';
...
export const localEnglishMdxDictionaryTitle = 'Manabitan Manual MDX Read Dictionary';
export const localEnglishMdxDescription = 'A tiny hand-built MDX dictionary for manually testing Read lookups in Manabitan. Includes entries for Read, read, and 読め.';
