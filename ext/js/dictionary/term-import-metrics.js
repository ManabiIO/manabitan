...
export const TERM_IMPORT_METRIC_KEYS = Object.freeze([
    ...
    'contentReferenceMs',
    'contentOpfsAppendMs',
    'contentInitialReservationCount',
    'contentInitialReservationSavingsMissCount',
    'contentMetadataMs',
    'contentMetadataStageMs',
    'contentMetadataPublishMs',
    'contentMetadataProjectionMs',
    'contentMetadataIndexPublishMs',
    'dedupPendingHitCount',
    'dedupPersistedHitCount',
    'dedupUniqueCount',
    'dedupExactFallbackCount',
    'dedupRecentSourceHitCount',
    'dedupRecentSourceCacheMs',
