    ...
    async _importDictionary(dictionaryDatabase, archiveContent, details, archiveOwnership) {
        ...
        try {
                ...
                if (streamedImportCompleted) {
                    ...
                    if (lastFastTermBankReadProfile !== null) {
                        ...
                        recordPhaseTiming(`term-file-fast-path:${streamedTermFileLabel}`, tFastParseStart, {
                            ...
                            parserKnownGlossaryKeyCount: parserProfile.knownGlossaryKeyCount ?? 0,
                            parserSchemaRowParseCount: parserProfile.schemaRowParseCount ?? 0,
                            parserSchemaRowFallbackCount: parserProfile.schemaRowFallbackCount ?? 0,
            ...
            recordPhaseTiming('import-data-banks', tImportBanksStart, {
                ...
                fastPathParserKnownGlossaryKeyCount: fastPathProfile?.knownGlossaryKeyCount ?? 0,
                fastPathParserSchemaRowParseCount: fastPathProfile?.schemaRowParseCount ?? 0,
                fastPathParserSchemaRowFallbackCount: fastPathProfile?.schemaRowFallbackCount ?? 0,
